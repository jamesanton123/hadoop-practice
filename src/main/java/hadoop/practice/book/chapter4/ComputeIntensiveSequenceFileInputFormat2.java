...
public class ComputeIntensiveSequenceFileInputFormat2<K, V> extends SequenceFileInputFormat<K, V> {
	...
	private boolean doesSplitHaveLocationMatchingServer(InputSplit split, String server) throws IOException {
		FileSplit fs = (FileSplit)split;
		// For each location in the original split
